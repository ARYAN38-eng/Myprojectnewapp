...
st.sidebar.image("olympic-logo-png-transparent.png")
...
if user_menu == 'Medal Tally':
    ...
    if selected_years!='Overall' and selected_country!=' Overall':
        st.title("Medal tally in "+ str(selected_years)+ " of " + str(selected_country))
...
if user_menu == 'Athlete wise Analysis':
    ...
    x=[]
    name=[]
    famous_sports=famous_sports=['Basketball','Judo','Football','Tug-Of-War','Athletics','Swimming','Badminton','Sailing','Gymnastics','Art Competitions',
              ...
              'Synchronized Swimming','Table Tennis','Baseball','Rhythmic Gymnastics','Rugby Sevens','Beach Volleyball','Triathlon','Rugby',
              'Polo','Ice Hockey']
